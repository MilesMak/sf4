 ...
 */
final class Version20191209123454 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD pseudo VARCHAR(40) NOT NULL, CHANGE roles roles JSON NOT NULL');
